...
<section
    ...
    < HaHa created extra <code tufte-haha.css > with some style for numbering of headers (if option <code -n > in on) and for the table
...
<section
    ...
    <INPUT,id=sn-example-sidenote > 
    <SN This is a sidenote. Sidenotes are like footnotes, except they 
